    ...
    <div className="min-h-screen flex flex-col bg-[#0E1511]">
      ...
      <div className="flex-1 flex items-center justify-center p-8 relative overflow-hidden">
        ...
        <div className="glass-panel w-full max-w-md p-10 border-[#1C2A22] relative z-10">
          ...
          <div className="mt-8">
            <button className="w-full bg-[#121A15] border border-[#1C2A22] text-white py-3 md:py-4 rounded-xl font-semibold hover:bg-[#1C2A22] transition-colors flex justify-center items-center gap-3">
