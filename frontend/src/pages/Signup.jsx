        ...
        <div className="relative z-10 flex flex-col justify-center px-16 py-12 w-full">
          ...
          <div className="mb-12">
            ...
            <p className="text-gray-400 text-lg max-w-md">
              Create your account and start detecting deepfake audio with cutting-edge AI technology.
            </p>
          </div>
          ...
          <div className="w-full max-w-md relative z-10">
            ...
            <form onSubmit={handleSignup} className="space-y-5">
              ...
              <div>
                ...
                <div className="relative group">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    <Mail className="h-5 w-5 text-gray-500 group-focus-within:text-neon-green transition-colors" />
                  </div>
                  <input
                    type="email"
                    required
            ...
            <div>
              ...
              <div className="mt-6 flex justify-center w-full">
                <button 
                  ...
                  className="w-full bg-[#121A15] border border-[#1C2A22] text-white py-3.5 rounded-xl font-semibold hover:bg-[#1C2A22] hover:border-[#2A3F33] transition-all flex justify-center items-center gap-3"
                >
