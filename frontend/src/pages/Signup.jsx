...
function getPasswordStrength(password) {
  ...
  return { score: 5, label: 'Excellent', color: '#00FF66' };
}
  ...
  const handleSignup = async (e) => {
    ...
    try {
      const response = await fetch(apiUrl('/api/signup'), {
        ...
        credentials: 'include',
        body: JSON.stringify({ name, email, password, guest_id: getGuestId() }),
      });
    ...
    <div className="min-h-screen flex bg-dark-bg">
      ...
      {success && (
        <div className="fixed top-6 inset-x-0 z-50 flex justify-center animate-slide-down">
          <div className="bg-dark-border border border-neon-green/30 rounded-xl px-6 py-4 flex items-center gap-3 shadow-[0_0_30px_rgba(0,255,102,0.15)]">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-linear-to-br from-[#0a1f0f] via-dark-bg to-[#071a0c] animate-gradient"></div>
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 py-8 w-full">
          ...
          <div className="mb-8">
            <h2 className="text-4xl font-bold text-white mb-4 leading-tight">
              ...
              <span className="text-neon-green">Audio Security</span>
            </h2>
            <p className="text-gray-400 text-lg max-w-md">
              Create an account to start detecting deepfake audio using advanced AI technology.
            </p>
          </div>
          ...
          <div className="space-y-3">
            {features.map((feature, i) => (
              <div
                key={feature.title}
                className="flex items-start gap-4 p-4 rounded-xl bg-white/3 border border-white/5 backdrop-blur-sm hover:bg-white/6 hover:border-neon-green/20 transition-all duration-300"
              >
      ...
      <div className="w-full lg:w-1/2 flex flex-col min-h-screen lg:min-h-0">
        ...
        <div className="flex-1 flex items-center justify-center p-4 sm:p-6 relative overflow-y-auto w-full max-w-125 mx-auto">
          {/* Subtle background glow */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-125 h-125 bg-neon-green/5 rounded-full blur-[120px] pointer-events-none"></div>
          ...
          <div className="w-full max-w-md relative z-10">
            ...
            <form onSubmit={handleSignup} className="space-y-4" noValidate>
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className={`w-full bg-[#121A15] border ${errors.name ? 'border-red-500/50' : 'border-dark-border'} text-white rounded-xl pl-11 pr-4 py-3 sm:py-3.5 text-sm focus:outline-none focus:border-neon-green/50 focus:shadow-[0_0_0_3px_rgba(0,255,102,0.08)] transition-all`}
              ...
              <div>
                ...
                <div className="relative group">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    <Mail className={`h-5 w-5 transition-colors ${isEmailInvalid ? 'text-red-500' : 'text-gray-500 group-focus-within:text-neon-green'}`} />
                  </div>
                  <input
                    type="email"
                    required
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className={`w-full bg-[#121A15] border ${errors.password ? 'border-red-500/50' : 'border-dark-border'} text-white rounded-xl pl-11 pr-12 py-3 sm:py-3.5 text-sm focus:outline-none focus:border-neon-green/50 focus:shadow-[0_0_0_3px_rgba(0,255,102,0.08)] transition-all`}
                    placeholder="••••••••"
                  />
                  <button
                    type="button"
                    ...
                    <div className="flex gap-1.5 mb-1.5">
                      {[1, 2, 3, 4, 5].map((level) => (
                        <div
                          ...
                          style={{
                            backgroundColor: level <= strength.score ? strength.color : '#1C2A22',
                          }}
                        />
                      ))}
                    </div>
            ...
            <div>
              ...
              <div className="mt-6 flex justify-center w-full">
                <button
                  ...
                  className="w-full bg-[#121A15] border border-dark-border text-white py-3 sm:py-3.5 rounded-xl font-semibold hover:bg-dark-border hover:border-[#2A3F33] transition-all flex justify-center items-center gap-3"
                >
