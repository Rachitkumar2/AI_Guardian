...
import { Shield, ArrowRight, User, Lock, Mail, Eye, EyeOff, CheckCircle2 } from 'lucide-react';
      ...
      <div className="flex-1 flex items-center justify-center p-8 relative overflow-hidden">
        ...
        <div className="glass-panel w-full max-w-md p-10 border-[#1C2A22] relative z-10 my-16">
          ...
          <form onSubmit={handleSignup} className="space-y-6">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full bg-[#121A15] border ${errors.name ? 'border-red-500/50' : 'border-[#1C2A22]'} text-white rounded-xl pl-12 pr-4 py-4 focus:outline-none focus:border-neon-green/50 transition-colors`}
            ...
            >
              {loading ? 'Creating...' : 'Start Free Trial'} <ArrowRight className="w-5 h-5" />
            </button>
          </form>
