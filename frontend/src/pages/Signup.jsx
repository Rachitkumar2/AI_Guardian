      ...
      {success && (
        <div className="fixed top-6 inset-x-0 z-50 flex justify-center animate-slide-down">
          <div className="bg-[#1C2A22] border border-[#2A3F33] rounded-xl px-6 py-4 flex items-center gap-3 shadow-lg">
            ...
            <span className="text-white font-semibold text-sm">Account created! Redirecting...</span>
          </div>
        </div>
      )}
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className={`w-full bg-[#121A15] border ${errors.name ? 'border-red-500/50' : 'border-[#1C2A22]'} text-white rounded-xl pl-11 pr-4 py-3 sm:py-3.5 text-sm focus:outline-none focus:border-neon-green/50 focus:shadow-[0_0_0_3px_rgba(0,255,102,0.08)] transition-all`}
